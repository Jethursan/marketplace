  ...
  return (
    <div className="flex flex-col w-full h-screen bg-slate-50 overflow-hidden">
      <nav className="flex-none z-20">
        <Navbar onSearch={(val) => setSearchQuery(val)} isVendor={true} />
      </nav>
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden relative">
        ...
        >
          <button
            ...
            className="absolute -right-3 top-6 bg-white border border-slate-200 rounded-full p-1 text-slate-400 hover:text-emerald-600 shadow-sm z-30"
          >
        ...
        <main className="flex-1 min-w-0 h-full overflow-y-auto">
          <div className="p-8 max-w-[1600px] mx-auto">
            {/* This is where VendorDashboard will show up */}
